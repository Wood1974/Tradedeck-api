...
```bash
cd shield
python -m pytest tests/ -q            # 159 tests — any failure is a finding
python audit/invariants.py            # 27 tripwires — any BROKEN is critical
```
...
> Audit YYYY-MM-DD: 159 tests pass, 27 invariants hold, nothing new on
