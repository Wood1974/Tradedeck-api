...
```bash
cd shield
python -m pytest tests/ -q            # 146 tests — any failure is a finding
python audit/invariants.py            # 22 tripwires — any BROKEN is critical
```
...
> Audit YYYY-MM-DD: 146 tests pass, 22 invariants hold, nothing new on
